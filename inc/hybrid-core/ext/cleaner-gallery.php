...
final class Cleaner_Gallery {
	...
	public function gallery_shortcode( $output, $attr ) {
		...
		$children = array(
			...
			'orderby'../../../hybrid-core/ext/          => $this->args['orderby'],
			'exclude'../../../hybrid-core/ext/          => $this->args['exclude'],
			'include'../../../hybrid-core/ext/          => $this->args['include'],
	...
	public function set_up_args( $attr ) {
		...
		$defaults = array(
			'order'       => 'ASC',
			'orderby'../../../hybrid-core/ext/     => 'menu_order ID',
			'id'          => get_the_ID(),
			'mime_type'   => 'image',
			'link'        => '',
			'itemtag'../../../hybrid-core/ext/     => 'figure',
			'icontag'../../../hybrid-core/ext/     => 'div',
			'captiontag'  => 'figcaption',
			'columns'     => 3,
			'size'        => has_image_size( 'post-thumbnail' ) ? 'post-thumbnail' : 'thumbnail',
			'ids'         => '',
			'include'../../../hybrid-core/ext/     => '',
			'exclude'     => '',
			'numberposts' => -1,
			'offset'      => '',
